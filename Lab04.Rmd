...
2. *BONUS QUESTION:* Now create a plot using `geom_ribbon`, to show how the uncertainty around the real tank-count value diminishes with every additional observation. Explain what the graph is showing, and discuss relevant reflections you might have. 
