...
The figure on the right suggests that the region of highest likelihood is in the vicinity where $\mu=0$ and $\sigma \in [^3/_4, 1]$
...
1.d. Instead of maximizing the likelihood, it is [common practice](https://www.youtube.com/watch?v=ddqny3aZNPY) to maximize the log-likelihood. Can you explain why? 
