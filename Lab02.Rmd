---
title: "Lab 02 - Binomial distribution"
...
* Please submit your lab using this link (TBD).   
...
1. From your sample, calculate the *likelihood* of Tom being in the maths department, if we observe that Tom is shy $P(B=0|S=1)$. 

1. Calculate the *Prior* of Tom being in the maths department $P(B=0)$, before even noticing whether Tom is shy or not. 
...
1. Now calculate the *posterior probability* of Tom being in the maths department, given that Tom is shy $P(B=0|S=1)$. Calculate this in two ways: 

    * First, remove all the students who are not shy from you dataset and find what proportion of those students are in the maths department. 
...
## Solving the Monty Hall problem using Bayes
